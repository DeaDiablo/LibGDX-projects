...
public class LevelGleed2DLoader extends AsynchronousAssetLoader<LevelGleed2D, LevelGleed2DLoader.GLEEDParameter > implements Disposable
{

  static public class GLEEDParameter extends AssetLoaderParameters<LevelGleed2D>
  {
  }

  private LevelGleed2D level = null;
  private String pathRoot = "data";
  private TextureAtlas atlas = null;
  private String atlasFile = null;
  private AssetManager assetManager;
  
  public LevelGleed2DLoader(FileHandleResolver resolver)
  {
    super(resolver);
  }
  ...
  @Override
  public LevelGleed2D loadSync (AssetManager manager, String fileName, FileHandle file, GLEEDParameter parameter)
  {
    return level;
  }
  ...
  private void loadLayer(Element element)
  {
    ...
    level.getLayers().put(layer.getName(), layer);
  }
  
  private void loadLayer(Layer layer, Element element)
  {
    ...
    GameLog.instance.writeLog("Loading layer: " + layer.getName());
  }
  
  private void loadElement(LayerObject levelObject, Element element)
  {
